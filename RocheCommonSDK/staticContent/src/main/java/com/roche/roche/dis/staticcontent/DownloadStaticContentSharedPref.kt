...
object DownloadStaticContentSharedPref {
    ...
    private const val USER_MANUALS_PREFS = "USER_MANUALS_PREFS"
    private const val PREF_KEY_ETAG_PREFIX = "key_etag"
    private const val PREF_KEY_FILE_PATH_PREFIX = "key_file_path"
